...
def home_page_fun(df):
    ...
    with col1:
        st.markdown('''
               <div align="center"><a href="https://jialiangchen99-streamlit-blog-main-2csjzy.streamlitapp.com/?blog=1" target="_parent"><img src="https://www.baidu.com/img/PCtm_d9c8750bed0b3c7d089fa7d55720d6cf.png"  width=160px height=160px/></a></div>
                ''',unsafe_allow_html=True)
        st.markdown('''
